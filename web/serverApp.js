...
const privateKey = fs.readFileSync(
  '/home/anderson/projects/nodeJs/express-demo/ssl_cert.key',
);
const certificate = fs.readFileSync(
  '/home/anderson/projects/nodeJs/express-demo/ssl_cert.crt',
);
const port = 5000;
const app = express();
app.use(
  '/static',
  express.static('/home/anderson/projects/agro-data/web/build/static'),
);
...
app.get('/', (request, response) => {
  ...
  fs.readFile(
    '/home/anderson/projects/agro-data/web/build/index.html',
    function(err, html) {
      if (err) {
        throw err;
      }
